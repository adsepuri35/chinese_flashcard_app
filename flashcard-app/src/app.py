...
def main():
    global root, label, entry, button, checkbox_frame, hanzi_var, pinyin_var, translations_var
    root = tk.Tk()
    ...
    button = tk.Button(root, text="Submit", command=submit_button_click, font=large_font)
    button.pack(pady=10)
